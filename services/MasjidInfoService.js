...
exports.findAll = async () => {
  try {
    const { rows } = await postgre.query("SELECT Id as id, masjid_name as MasjidName, masjid_address as MasjidAddress, city as City, province as Province, bkm_pic as BkmPic, bkm_phone as BkmPhone FROM masjid_info");
...
exports.update = async (id, data) => {
  ...
  try {
    const { MasjidName, MasjidAddress, City, Province, BkmPic, BkmPhone } = data;
    ...
    const { rows } = await postgre.query(sql, [MasjidName, MasjidAddress, City, Province, BkmPic, BkmPhone, id]);
